...
Note that the model generally performs much worse for the R pool, as this pool is (currently) much smaller for most countries, and it is therefore harder to get accurate estimates of rates.
...
matplot(1:ndays, log(cmat+0.1), col=collst, type="b", pch=1:ncountries, ylab="c", xlab="days", axes=FALSE)
axis(1)
...
matplot(1:ndays, log(mmat+0.1), col=collst, type="b", pch=1:ncountries, ylab="m", xlab="days", axes=FALSE)
axis(1)
#adjust axis for cutoff
